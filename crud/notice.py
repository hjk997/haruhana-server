...
from schemas.notice import NoticeCreate, NoticeList, NoticeTokenCreate, NoticeUpdateAllRead, NoticeUpdateRead, NoticeUpdateSend, NoticeDelete
...
# 알림 토큰 생성 
# -----------------------------
def create_notification_token(param: NoticeTokenCreate, db: Session):
